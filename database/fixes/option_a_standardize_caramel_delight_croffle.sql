-- OPTION A: Standardize name and materialize product_ingredients for "Caramel Delight Croffle"
...
WHERE product_name = 'Caramel Delight  Croffle'
...
WHERE pc.product_name IN ('Caramel Delight  Croffle', 'Caramel Delight Croffle')
...
SET product_name = 'Caramel Delight Croffle', updated_at = NOW()
WHERE product_name = 'Caramel Delight  Croffle';
...
FROM product_catalog
WHERE product_name IN ('Caramel Delight Croffle', 'Caramel Delight  Croffle')

  ...
  public: {
    Tables: {
      ...
      failed_inventory_queue: {
        ...
        Relationships: [
          {
            foreignKeyName: "failed_inventory_queue_store_id_fkey"
            columns: ["store_id"]
            isOneToOne: false
            referencedRelation: "recipe_management_summary"
            referencedColumns: ["store_id"]
          ...
          {
            foreignKeyName: "failed_inventory_queue_transaction_id_fkey"
      ...
      mix_match_ingredient_deductions: {
        Row: {
          base_name: string
          created_at: string
          id: string
        ...
        Relationships: [
          {
            foreignKeyName: "mix_match_ingredient_deductions_inventory_stock_id_fkey"
            columns: ["inventory_stock_id"]
            isOneToOne: false
            referencedRelation: "inventory_stock"
            referencedColumns: ["id"]
        ...
        Relationships: [
          {
            ...
            isOneToOne: false
            referencedRelation: "product_availability_summary"

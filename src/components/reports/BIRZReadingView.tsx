...
import { BIRZReadingData } from '@/services/reports/modules/enhancedZReadingReport';
...
interface BIRZReadingViewProps {
  data: BIRZReadingData;
}

export function BIRZReadingView({ data }: BIRZReadingViewProps) {
  const { isConnected, printZReading, isPrinting } = useThermalPrinter();
    ...
    <div className="space-y-4">
      ...
      <div className="font-mono text-xs bg-white p-4 max-w-sm mx-auto">
        ...
        <div className="border-t border-b border-dashed border-gray-400 py-2 mb-4">
          <div className="text-center font-bold">Z-READING</div>
          ...
          <div className="text-center">MANAGER: {data.managerName}</div>
        </div>
        ...
        {/* Cash Count */}
        <div className="mb-4">
          <div className="font-bold underline">CASH COUNT</div>
          <div className="flex justify-between">
            <span>BEG CASH:</span>
          ...
          <div className="flex justify-between">
            <span>REFUNDS:</span>
            <span>{formatCurrency(data.totalRefunds)}</span>
          </div>
          ...
          <div className="flex justify-between font-bold border-t-2 border-gray-400 pt-1">
            <span>CASH VARIANCE:</span>
            <span className={data.cashVariance >= 0 ? 'text-green-600' : 'text-red-600'}>

...
import { Warehouse, ShoppingCart, RefreshCw, Users, BarChart3 } from "lucide-react";
    ...
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage raw materials, supplier relationships, and store restocking
          </p>
        </div>
      </div>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
        <TabsList className="grid w-full grid-cols-5">
          ...
          <TabsTrigger value="restock-requests" className="flex items-center gap-2">
        ...
        <TabsContent value="restock-requests">
          <RestockRequestsTab />
        </TabsContent>

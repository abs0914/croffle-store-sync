...
export function BulkUploadTab({
  ...
  const handleDownloadTemplate = (type: string) => {
    ...
    switch (type) {
      case 'commissary':
        // Updated template without item_price and item_quantity columns
        csvContent = ['name,category,uom,unit_cost,current_stock,minimum_threshold,supplier_name,sku,storage_location', 'Regular Croissant,raw_materials,1 Box,150.00,10,2,Supplier Name,RAW-CROIS-REG,Cold Storage', 'Biscoff Crushed,raw_materials,1 Kilo,180.00,5,1,Biscoff Supplier,RAW-BISC-CRUSH,Dry Storage', 'Biscoff Spread,raw_materials,680 grams,320.00,8,2,Biscoff Supplier,RAW-BISC-SPREAD,Dry Storage', 'Chocolate Bar Crushed,raw_materials,500 grams,250.00,6,1,Chocolate Co,RAW-CHOC-CRUSH,Dry Storage', 'Chocolate Chips,raw_materials,1 Kilo,380.00,4,1,Chocolate Co,RAW-CHOC-CHIPS,Dry Storage', 'Chocolate Syrup,raw_materials,630 grams,200.00,12,3,Chocolate Co,RAW-CHOC-SYR,Dry Storage', 'Whipped Cream,raw_materials,1 Liter,120.00,15,3,Dairy Co,RAW-CREAM-WHIP,Cold Storage', 'Ice Cream,raw_materials,2500 grams,280.00,8,2,Dairy Co,RAW-ICECREAM,Freezer', 'Almonds Crushed,raw_materials,454 grams,420.00,5,1,Nuts Co,RAW-ALMOND-CRUSH,Dry Storage', 'Almonds Sliced,raw_materials,454 grams,400.00,6,1,Nuts Co,RAW-ALMOND-SLICE,Dry Storage', 'Peanuts,raw_materials,1 Kilo,180.00,4,1,Nuts Co,RAW-PEANUTS,Dry Storage', 'Banana,raw_materials,1 Kilo,80.00,20,5,Fresh Fruits,RAW-BANANA,Room Temperature', 'Strawberry,raw_materials,500 grams,150.00,10,3,Fresh Fruits,RAW-STRAWBERRY,Cold Storage', 'Caramel Sauce,raw_materials,750 grams,180.00,8,2,Sauce Co,RAW-CARAMEL,Dry Storage', 'Nutella,raw_materials,900 grams,450.00,6,2,Nutella Co,RAW-NUTELLA,Dry Storage', 'Peanut Butter,raw_materials,510 grams,220.00,7,2,PB Co,RAW-PB,Dry Storage', 'Milk,raw_materials,1 Liter,65.00,25,5,Dairy Co,RAW-MILK,Cold Storage', 'Croissant Box,packaging_materials,Pack of 50,125.00,20,5,Packaging Co,PKG-CROIS-BOX,Storage Room', 'Food Container Small,packaging_materials,Pack of 100,180.00,15,3,Packaging Co,PKG-CONT-SM,Storage Room', 'Food Container Large,packaging_materials,Pack of 50,220.00,12,3,Packaging Co,PKG-CONT-LG,Storage Room'].join('\n');
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div>
              ...
              <ul className="text-sm text-muted-foreground space-y-1">
                ...
                <li>• Unit cost for pricing calculations</li>
              </ul>
            </div>
            <div>
              <h4 className="font-medium mb-3 flex items-center gap-2">

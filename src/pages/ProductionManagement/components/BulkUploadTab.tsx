  ...
  const handleDownloadTemplate = (type: string) => {
    ...
    switch (type) {
      ...
      case 'conversion':
        ...
        break;
      case 'menu':
        csvContent = ['name,category,description,yield_quantity,serving_size,instructions,ingredient name,quantity used,unit of measure,cost per unit', 'Chocolate Chip Cookies,Desserts,Classic chocolate chip cookies,24,1,Mix dry ingredients then add wet ingredients,All-Purpose Flour,2,kg,0.50', 'Chocolate Chip Cookies,,,,,,,Chocolate Chips,0.5,kg,8.50', 'Chocolate Chip Cookies,,,,,,,Sugar,0.3,kg,1.20', 'Vanilla Cake,Cakes,Moist vanilla cake perfect for celebrations,1,8,Cream butter and sugar then alternate dry and wet ingredients,All-Purpose Flour,1.5,kg,0.50', 'Vanilla Cake,,,,,,,Vanilla Extract,50,ml,0.25'].join('\n');
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                <StoreSelector stores={stores} selectedStoreId={selectedStoreId} onStoreChange={setSelectedStoreId} />
                <RecipeUpload />
              </div>
            </CardContent>
          </Card>

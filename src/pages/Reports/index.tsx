...
export type ReportType = 'sales' | 'expense' | 'profit_loss' | 'product_sales' | 'x_reading' | 'z_reading' | 'bir_ejournal' | 'bir_backup' | 'void_report' | 'cashier' | 'daily_shift' | 'inventory_status' | 'robinsons_compliance';

...
const InventoryHeader = ({
  ...
  return <div className="mb-6">
      <div className="flex justify-between items-start">
        ...
        {showActions && <div className="flex space-x-2">
            {onDownloadTemplate && <Button variant="outline" size="sm" className="flex items-center gap-1" onClick={onDownloadTemplate}>
                <Download className="h-4 w-4" />
                <span className="hidden sm:inline">Template</span>
              </Button>}
            {onImportClick && <Button variant="outline" size="sm" className="flex items-center gap-1" onClick={onImportClick}>
                <Import className="h-4 w-4" />
                <span className="hidden sm:inline">Import</span>
              </Button>}
            {onExportCSV && <Button variant="outline" size="sm" className="flex items-center gap-1" onClick={onExportCSV}>

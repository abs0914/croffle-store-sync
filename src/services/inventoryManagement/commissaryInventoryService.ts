...
export const fetchCommissaryInventory = async (filters?: CommissaryInventoryFilters): Promise<CommissaryInventoryItem[]> => {
  try {
    ...
    return (data || []).map(item => ({
      ...
      supplier: item.supplier && typeof item.supplier === 'object' && 'id' in item.supplier && item.supplier !== null
...
export const createCommissaryInventoryItem = async (
  ...
  try {
    ...
    return {
      ...
      supplier: data.supplier && typeof data.supplier === 'object' && 'id' in data.supplier && data.supplier !== null

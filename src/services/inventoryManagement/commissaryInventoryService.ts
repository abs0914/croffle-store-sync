...
export const fetchCommissaryInventory = async (filters?: CommissaryInventoryFilters): Promise<CommissaryInventoryItem[]> => {
  try {
    ...
    return (data || []).map(item => ({
      ...
      supplier: item.supplier !== null && typeof item.supplier === 'object' && 'id' in item.supplier
...
export const createCommissaryInventoryItem = async (
  ...
  try {
    ...
    return {
      ...
      supplier: data.supplier !== null && typeof data.supplier === 'object' && 'id' in data.supplier

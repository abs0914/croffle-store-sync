-- Temporarily disable the sync trigger to avoid duplicate product creation
ALTER TABLE product_catalog DISABLE TRIGGER sync_product_catalog_changes_trigger;

-- Update product_catalog entries individually to link to recipes
...
ALTER TABLE product_catalog ENABLE TRIGGER sync_product_catalog_changes_trigger;
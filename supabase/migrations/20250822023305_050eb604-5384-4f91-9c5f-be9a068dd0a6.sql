-- Add ingredients to existing recipes that are missing them in Sugbo Mercado

-- Add ingredients to Matcha recipe
INSERT INTO recipe_ingredients (recipe_id, ingredient_name, quantity, unit, cost_per_unit)
SELECT r.id, ingredient, qty, unit_val, cost FROM recipes r
CROSS JOIN (VALUES
  ('Matcha Powder', 15, 'grams', 5.00),

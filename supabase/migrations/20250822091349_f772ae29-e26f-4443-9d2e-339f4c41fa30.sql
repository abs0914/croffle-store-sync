-- Fixed inventory sync with correct type casting approach
DO $$
DECLARE
        ...
        LOOP
            ...
            IF transaction_item.recipe_id IS NOT NULL THEN
                ...
                LOOP
                    ...
                    -- Find matching inventory item with proper unit matching
                    ...
                    WHERE store_id = transaction_record.store_id
                      ...
                      AND unit = ingredient_record.unit::inventory_unit  -- Cast text to enum
                      AND is_active = true
                    LIMIT 1;

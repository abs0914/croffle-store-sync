...
-- Handle existing mappings and avoid duplicate key violations
...
-- Step 5: Create mappings for other corrected ingredients
INSERT INTO recipe_ingredient_mappings (
    recipe_id,
    ingredient_name,
    inventory_stock_id,
...
SELECT 
    ...
    'Recipe ingredients and mappings updated for inventory deduction' as message,

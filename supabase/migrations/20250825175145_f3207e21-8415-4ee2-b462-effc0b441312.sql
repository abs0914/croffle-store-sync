-- Clean up and sync product catalog (Handle existing recipes properly)
...
-- (We'll recreate them from templates)
...
-- Step 5: Add ingredients from templates to all template-linked recipes

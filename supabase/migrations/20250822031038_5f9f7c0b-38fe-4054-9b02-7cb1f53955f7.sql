...
ALTER TABLE product_catalog DISABLE TRIGGER sync_product_catalog_changes;

-- Create recipes for products that need them
...
ALTER TABLE product_catalog ENABLE TRIGGER sync_product_catalog_changes;

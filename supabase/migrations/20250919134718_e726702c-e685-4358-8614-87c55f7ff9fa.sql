...
-- First, update conversion mappings to reference Popsicle Stick before deleting Popsicle inventory
UPDATE conversion_mappings 
SET recipe_ingredient_name = 'Popsicle Stick',
    updated_at = NOW()
WHERE LOWER(TRIM(recipe_ingredient_name)) = 'popsicle';

-- Update recipe ingredients that reference "Popsicle" to "Popsicle Stick" 

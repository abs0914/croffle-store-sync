-- Final Corrected Recipe Migration: Copy all existing recipes to unified system
-- This migration preserves all existing data while enabling the unified system

-- Step 1: Migrate all recipes from recipes table to unified_recipes (correct columns)
...
-- Step 2: Migrate recipe ingredients (using existing inventory_stock_id)

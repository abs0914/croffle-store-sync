-- Create migration function to move product_catalog entries to products table
CREATE OR REPLACE FUNCTION migrate_product_catalog_to_products()
...
BEGIN
  ...
  FOR catalog_record IN 
    SELECT pc.*, rt.total_cost as recipe_cost
  ...
  LOOP
    BEGIN
      ...
      INSERT INTO products (
        ...
        CASE WHEN catalog_record.is_available THEN 'available' ELSE 'temporarily_unavailable' END,
...
-- Create function to deploy products to all stores
CREATE OR REPLACE FUNCTION deploy_products_to_all_stores()
    ...
    LOOP
      BEGIN
        ...
        INSERT INTO products (
          ...
          CASE WHEN product_record.is_active THEN 'available' ELSE 'temporarily_unavailable' END,

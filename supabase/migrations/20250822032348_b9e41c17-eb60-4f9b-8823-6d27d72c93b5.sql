-- Strategic approach: Create recipes and link them carefully to avoid sync conflicts

-- Step 1: Create all the recipes first (no linking yet)
...
-- Step 2: Link existing products to the new recipes directly (no triggers on products table)
UPDATE products 

-- Fix the log_bir_audit function to properly handle the digest function
-- The issue is that the function parameters need proper type casting for digest()
...
BEGIN
    ...
    -- Generate hash with proper type casting - fix the digest function call

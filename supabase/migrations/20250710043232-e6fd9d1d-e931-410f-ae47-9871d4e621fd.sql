...
INSERT INTO public.product_addon_items (addon_category_id, name, price, cost, is_premium, display_order) VALUES
((SELECT id FROM public.addon_categories WHERE name = 'Classic Toppings' LIMIT 1), 'Sprinkles', 6.00, 2.00, false, 1),
((SELECT id FROM public.addon_categories WHERE name = 'Classic Toppings' LIMIT 1), 'Chocolate Chips', 8.00, 3.00, false, 2),
((SELECT id FROM public.addon_categories WHERE name = 'Premium Toppings' LIMIT 1), 'Nutella', 10.00, 4.00, true, 1),
((SELECT id FROM public.addon_categories WHERE name = 'Premium Toppings' LIMIT 1), 'Fresh Strawberries', 12.00, 6.00, true, 2),
((SELECT id FROM public.addon_categories WHERE name = 'Classic Sauces' LIMIT 1), 'Chocolate Syrup', 5.00, 2.00, false, 1),
((SELECT id FROM public.addon_categories WHERE name = 'Premium Sauces' LIMIT 1), 'Salted Caramel', 8.00, 3.50, true, 1)

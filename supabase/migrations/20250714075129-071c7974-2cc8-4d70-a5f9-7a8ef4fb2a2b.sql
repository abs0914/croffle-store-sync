...
('Classic + Iced Espresso', 'Classic', 'Espresso', 135, 0, true, 2),

-- Glaze + Espresso combos  
('Glaze + Hot Espresso', 'Glaze', 'Espresso', 129, 0, true, 3),
('Glaze + Iced Espresso', 'Glaze', 'Espresso', 134, 0, true, 4),

-- Fruity + Espresso combos
('Fruity + Hot Espresso', 'Fruity', 'Espresso', 140, 0, true, 5),
('Fruity + Iced Espresso', 'Fruity', 'Espresso', 145, 0, true, 6),

-- Premium + Espresso combos
('Premium + Hot Espresso', 'Premium', 'Espresso', 165, 0, true, 7),
('Premium + Iced Espresso', 'Premium', 'Espresso', 170, 0, true, 8),

-- Keep existing Mini Croffle combos (now use different category names to avoid conflicts)
('Mini Croffle + Hot Espresso', 'Mini Croffle', 'Espresso', 110, 0, true, 9),
('Mini Croffle + Iced Espresso', 'Mini Croffle', 'Espresso', 115, 0, true, 10);
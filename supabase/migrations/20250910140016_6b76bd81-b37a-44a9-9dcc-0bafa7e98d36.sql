...
SET 
  cost = CASE 
    WHEN item = 'Whipped Cream' THEN 0.10
...
SET 
  ...
  END,
  unit = CASE 
    WHEN ingredient_name = 'Whipped Cream' THEN 'ml'::inventory_unit

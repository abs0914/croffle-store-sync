-- COMPREHENSIVE PREMIUM PRODUCT INVENTORY MAPPING FIXES (FIXED)
...
-- First, insert templates only if they don't exist
...
-- Update recipe ingredients units (this might need to be done carefully due to enum constraints)
-- We'll skip this for now to avoid enum issues

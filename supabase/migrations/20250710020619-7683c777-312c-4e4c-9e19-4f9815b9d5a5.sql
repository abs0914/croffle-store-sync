-- Clean Slate Migration (Final Fix): Remove Historical Data and Old Processes
...
-- Step 5: Restructure inventory_stock for direct unit system only
ALTER TABLE inventory_stock 
...
-- Step 6: Update all existing inventory to use direct serving units

-- Fix Missing Rectangle Ingredients and Unit Inconsistencies

-- Step 1: Add missing Rectangle ingredients to recipes that should have them
-- Check which recipes are missing Rectangle ingredients
...
-- Step 2: Fix Whipped Cream unit inconsistencies (change ml to serving)
UPDATE recipe_ingredients 
SET 
  unit = 'serving'::inventory_unit,
  updated_at = NOW()

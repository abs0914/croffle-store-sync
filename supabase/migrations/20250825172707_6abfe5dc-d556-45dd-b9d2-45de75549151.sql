...
SELECT 
  ...
  CASE 
    ...
    WHEN LOWER(rti.ingredient_name) LIKE '%stirrer%' OR LOWER(rti.ingredient_name) LIKE '%sugar%' OR LOWER(rti.ingredient_name) LIKE '%creamer%' THEN 'packaging'::inventory_item_category

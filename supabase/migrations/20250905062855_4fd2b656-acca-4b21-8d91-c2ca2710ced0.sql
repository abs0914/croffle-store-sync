...
-- First, let's find the correct inventory stock IDs for mapping
  ...
  SELECT 
    ...
    CASE 
      WHEN rti.ingredient_name = 'Regular Croissant' THEN 
        (SELECT id FROM inventory_stock WHERE item ILIKE '%croissant%' AND store_id = 'd7c47e6b-f20a-4543-a6bd-000398f72df5' AND is_active = true LIMIT 1)
      WHEN rti.ingredient_name = 'Caramel Sauce' THEN 
        (SELECT id FROM inventory_stock WHERE item = 'Caramel Sauce' AND store_id = 'd7c47e6b-f20a-4543-a6bd-000398f72df5' AND is_active = true LIMIT 1)
      WHEN rti.ingredient_name = 'Whipped Cream' THEN 
        (SELECT id FROM inventory_stock WHERE item ILIKE '%cream%' AND store_id = 'd7c47e6b-f20a-4543-a6bd-000398f72df5' AND is_active = true LIMIT 1)
      WHEN rti.ingredient_name = 'Colored Sprinkles' THEN 
        (SELECT id FROM inventory_stock WHERE item ILIKE '%sprinkles%' AND store_id = 'd7c47e6b-f20a-4543-a6bd-000398f72df5' AND is_active = true LIMIT 1)
      WHEN rti.ingredient_name = 'Chopstick' THEN 
        (SELECT id FROM inventory_stock WHERE item ILIKE '%chopstick%' AND store_id = 'd7c47e6b-f20a-4543-a6bd-000398f72df5' AND is_active = true LIMIT 1)
      WHEN rti.ingredient_name = 'Wax Paper' THEN 
        (SELECT id FROM inventory_stock WHERE item ILIKE '%paper%' AND store_id = 'd7c47e6b-f20a-4543-a6bd-000398f72df5' AND is_active = true LIMIT 1)

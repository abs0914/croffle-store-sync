-- Fix the deduct_recipe_ingredients_on_sale trigger function UUID casting issue
DROP FUNCTION IF EXISTS public.deduct_recipe_ingredients_on_sale() CASCADE;
...
BEGIN
    ...
    SELECT created_by INTO transaction_user_id
    FROM transactions 

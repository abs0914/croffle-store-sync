-- Fix the deployment function to handle all recipe template units properly
    ...
    LOOP
      ...
      IF existing_recipe_id IS NOT NULL THEN
        ...
        IF existing_ingredient_count < template_ingredient_count THEN
          -- Fix incomplete recipe by adding missing ingredients with proper unit mapping
          ...
          SELECT 
            ...
            CASE 
              ...
              -- Map other units to the closest inventory unit
              WHEN LOWER(rti.unit) = 'pair' THEN 'pieces'::inventory_unit
              WHEN LOWER(rti.unit) = 'serving' THEN 'pieces'::inventory_unit
              WHEN LOWER(rti.unit) = 'portion' THEN 'pieces'::inventory_unit
              WHEN LOWER(rti.unit) = 'scoop' THEN 'pieces'::inventory_unit
      ...
      -- Copy template ingredients to recipe ingredients with proper unit mapping
      INSERT INTO recipe_ingredients (
        recipe_id,
        ingredient_name,
        quantity,

-- COMPREHENSIVE COFFEE RECIPE INGREDIENT CORRECTIONS (FIXED CREATED_BY)
...
-- Record audit trail for retroactive corrections (with created_by field)
...
SELECT 
    ...
    END,
    -- Use system UUID for created_by (system corrections)

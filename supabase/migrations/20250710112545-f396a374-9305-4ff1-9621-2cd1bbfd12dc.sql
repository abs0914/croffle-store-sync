...
-- Direct insertion of 15 croffle recipes
...
BEGIN
  ...
  INSERT INTO recipe_templates (id, name, description, category_name, instructions, yield_quantity, serving_size, version, is_active, created_by, total_cost, suggested_price) VALUES
  (tiramisu_id, 'Tiramisu', 'Classic croffle with tiramisu flavor', 'Classic', '1. Prepare tiramisu base\n2. Add all ingredients as specified\n3. Serve with chopsticks and wax paper', 1, 1, 1, true, current_user_id, 45.3, 125),
  (choco_nut_id, 'Choco Nut', 'Classic croffle with chocolate and nuts', 'Classic', '1. Prepare choco nut base\n2. Add all ingredients as specified\n3. Serve with chopsticks and wax paper', 1, 1, 1, true, current_user_id, 44.3, 125),
